<template>
  <div class="Admin">
    <h1>
      This will help you keep track of all EventsPost <br />
      Bookings being made and Users
    </h1>
  </div>
  <div class="tables">
    <table class="table">
        ...
        <tr>
          ...
          <td>
            <button
              ...
              :data-bs-target="'#exampleModal' + item.eventID"
            >
              Edit
            </button>
          </td>
          <td>
            <button class="del-btn" @click="deleteeventPost(item.eventID)">
              Delete
            </button>
          </td>
        </tr>
  ...
  <table class="table">
    ...
    <tbody id="whereTheyDisplay" v-for="item in users" :key="item.userID">
      <tr>
        <td>{{ item.userID }}</td>
        <td>{{ item.userName }}</td>
        <td>{{ item.userAge }}</td>
        ...
        <td>
          <button class="del-btn" @click="deleteUsers(item.usersID)">
            Delete
          </button>
        </td>
      </tr>
